        ...
        function updateServiceGuideCard(serviceId) {
            ...
            if (selectedService) {
                html += '' +
                    '<div class="service-guide-header selected-service-header">' +
                        '<div class="service-guide-header-left">' +
                            ...
                            '</span>' +
                            '<h2 class="service-guide-title selected-service-title">About ' + escapeHtml(selectedService.name) + '</h2>' +
                        '</div>' +
                        '<span class="service-guide-badge">Step 1 of 4</span>' +
                    '</div>';

                if (selectedService.description) {
                    html += '<p class="service-guide-description selected-service-description">' + escapeHtml(selectedService.description) + '</p>';
                } else {
                    html += '<p class="service-guide-description selected-service-description text-muted">Professional cleaning service tailored to your requirements.</p>';
                }

                html += '<hr class="service-guide-divider">';

                html += '<div class="whats-included-wrapper">';
                ...
                if (Array.isArray(items) && items.length > 0) {
                    html += '<ul class="whats-included-list selected-whats-included-list">';
                ...
                html += '<div class="selected-service-illustration">' + buildingSvg + '</div>';
                html += '</div>';
                ...
                html += '' +
                    ...
                    '<div class="service-guide-helper-box">' +
                        ...
                        '</div>' +
                        '<div class="helper-box-illustration">' + helperSvg + '</div>' +
                    '</div>' +
